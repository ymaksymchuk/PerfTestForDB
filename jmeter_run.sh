#!/usr/bin/env bash
#java -jar ./jmeter/bin/ApacheJMeter.jar -n -f -t ./jmeter_test_cases/PostgreSQL/TestCase#4_Postgre.jmx -l ./jmeter_test_result/PostgreSQL/TC#1/general_test_result.jtl -e -o ./jmeter_reports/PostgreSQL/TC#1/
