...
case $TEST_CASE_NUMBER in
  ...
  1)
    ...
    RESULT_FOLDER=./jmeter_test_result/MS_SQL/Simulation#1/TC#1/
    ;;
  ...
  2)
    ...
    RESULT_FOLDER=./jmeter_test_result/MS_SQL/Simulation#1/TC#2/
    ;;
  ...
  3)
    ...
    RESULT_FOLDER=./jmeter_test_result/MS_SQL/Simulation#1/TC#3/
    ;;
  ...
  4)
    ...
    RESULT_FOLDER=./jmeter_test_result/MS_SQL/Simulation#1/TC#4/
    ;;
  ...
  5)
    ...
    RESULT_FOLDER=./jmeter_test_result/MS_SQL/Simulation#1/TC#5/
    ;;
