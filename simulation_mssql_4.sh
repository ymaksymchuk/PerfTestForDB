...
case $TEST_CASE_NUMBER in
  ...
  1)
    ...
    GRAF_FILE=./jmeter_test_result/MS_SQL/Simulation#4/TC#1/general_test_result.jtl
    GRAF_FOLDER=./jmeter_test_result/MS_SQL/Simulation#4/TC#1/
    ;;
  ...
  2)
    ...
    GRAF_FILE=./jmeter_test_result/MS_SQL/Simulation#4/TC#2/general_test_result.jtl
    GRAF_FOLDER=./jmeter_test_result/MS_SQL/Simulation#4/TC#2/
    ;;
  ...
  3)
    ...
    GRAF_FILE=./jmeter_test_result/MS_SQL/Simulation#4/TC#3/general_test_result.jtl
    GRAF_FOLDER=./jmeter_test_result/MS_SQL/Simulation#4/TC#3/
    ;;
  ...
  4)
    ...
    GRAF_FILE=./jmeter_test_result/MS_SQL/Simulation#4/TC#4/general_test_result.jtl
    GRAF_FOLDER=./jmeter_test_result/MS_SQL/Simulation#4/TC#4/
    ;;
  ...
  5)
    ...
    GRAF_FILE=./jmeter_test_result/MS_SQL/Simulation#4/TC#5/general_test_result.jtl
    GRAF_FOLDER=./jmeter_test_result/MS_SQL/Simulation#4/TC#5/
    ;;
